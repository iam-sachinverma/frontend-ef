...
const Review = ({ reviews, classNames }) => {
    ...
    <div className="py-12 px-4 md:px-6 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center">
      <div className="flex flex-col justify-start items-start w-full space-y-8">
        <div className="flex justify-start items-start">
          <p className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9 text-blue p-1 rounded-md bg-beige">
            What our Customers Say?
          </p>
        </div>
        <div className="w-full flex justify-start items-start flex-col bg-lightgreen shadow-md rounded-md p-8">
              ...
              <div className="flex-col md:flex-row flex justify-between w-full">
                <div className="flex flex-row justify-between items-start">
                  <div className="w-full flex flex-col relative h-full">
                    <span>
                      <div className="quote opacity-80 text-blue relative p-2">
                        <svg
                          width="40"
                          height="40"
                          viewBox="0 0 330 307"
                    ...
                    <h3 className="text-2xl p-2 text-grey uppercase mt-5 top-20 font-light">
                      {review.user_name}
                    </h3>
                    <p className="text-xl p-2 text-grey uppercase mt-5 top-32 font-light">{review.review}</p>
