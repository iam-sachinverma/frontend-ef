        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500">
              Now browse our exclusive range of sustainable products custom made
              for your needs.
            </p>
          </div>
          <div>
                      ...
                      <div className="w-44 h-64 rounded-lg overflow-hidden sm:opacity-0 lg:opacity-100">
                        <a href={`/shop`}>
                          <img
                            loading="lazy"
                            src={
                              "https://ik.imagekit.io/de3sec/assets/Number_2_a-YvjfHWY.png?ik-sdk-version=javascript-1.4.3&updatedAt=1659467121777"
                            }
                            alt=""
