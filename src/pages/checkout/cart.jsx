...
import { createOrder, checkoutSession, getCartState } from '../../redux/apiCalls';
      ...
      <div className="cart">
        <div className="w-full flex flex-col lg:flex-row center">
          <div className="flex flex-col max-w-3xl lg:w-full p-6 space-y-4 sm:p-10 dark:bg-coolGray-900 dark:text-coolGray-100">
            <h2 className="text-xl border p-2 text-blue font-light">
              Your cart
            </h2>
          ...
          <div className="flex flex-col m-6 h-80 overflow-y-scroll lg:flex">
            <span className="ml-6 rounded-md p-2 bg-blue text-green">
              Choose an address:
            </span>
            {user !== null ? (
            ...
            <button
              type="button"
              className="p-4 ml-16 mt-5 h-20 w-20 border rounded-full bg-lightgreen border-lightgreen"
              onClick={() => {
                navigate("/address");
              }}
            >
